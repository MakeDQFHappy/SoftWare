...
public class RegisterServiceImpl implements RegisterService {
  ...
  public Boolean insertUser(RegisterDTO registerDTO) {
    ...
    //检验是否为空
    if (registerDTO.getUserName() == null || registerDTO.getSex() == null
        || registerDTO.getEmail() == null || registerDTO.getBirthYear() == null) {
      return false;
    }
    //检验用户名是否大于二十
    ...
    //检验性别
    if (!Objects.equals(registerDTO.getSex(), "男") && !Objects.equals(registerDTO.getSex(),
        "nv")) {
      return false;
    }
    ...
    users.setUserAvatar(
        "https://wc-project.oss-cn-shanghai.aliyuncs.com/%E7%94%A8%E6%88%B7%E5%A4%B4%E5%83%8F.png");
